...
<head>
    ...
    <script type="text/javascript" src="js/ArgoPost.js">
</script>
    <script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js">
</script>
    <script type="text/javascript" src="js/createPost.js">
</script>
</head>
...
<body>
            ...
            <table border="0" cellspacing="0">
                <tbody id="searchResults">
                    ...
                    <tr id="searchResultsImage">
                        <td class="photo"><img src="images/smallPic.png" alt=" " width="50" height="50" align="top" /></td>

                        <td class="text" id="searchResultsContent"></td>
                    </tr>
                </tbody>
            </table>
        </div>
    ...
    <div id="footer">
        <div>
            <p>&#169; UWF ArgoPost. All Rights Reserved.</p>

            <div class="connect">
                <a href="index.cfm">Home</a> <a href="subscriptions.html">Subscriptions</a> <a href="createpost.html">Create Post</a> <a href="">Logout</a>
            </div>
        </div>
    </div>
</body>
