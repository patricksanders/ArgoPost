<cfcomponent output="false">
	...
	<cffunction name="onApplicationStart" returnType="boolean" output="false">
    	<!--- declare application scope variables here --->
		<cfreturn true>
	</cffunction>
	...
	<cffunction name="onRequestStart" returnType="boolean" output="false">
        ...
        <!--- things to do before loading the page --->
	...
	<cffunction name="onError" returnType="void" output="false">
        ...
        <!--- Highly recommend making the error not visible to users after development as it can be a security risk. You can have the system email someone with the error. --->
